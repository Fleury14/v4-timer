        ...
        return (
            <React.Fragment>
                ...
                <div className="flag-presets">
                    ...
                    <button onClick={() => this.setState({ flags: 'O1:quest_forge/2:quest_toroiatreasury/random:2,tough_quest/req:all/win:crystal Kmain/summon/moon/nofree Pkey Crelaxed/nofree/no:fusoya/j:abilities/nekkie/hero Tpro Sstandard Bstandard/alt:gauntlet/whichburn Etoggle Glife/sylph/backrow -kit:freedom -kit2:random -noadamants' })}>cHero</button>
                    <button onClick={() => this.setState({ flags: 'O2:quest_monsterking/4:quest_whitealtar/random:5,tough_quest/req:6/win:crystal Kmain/summon/moon/nofree Pkey Crelaxed/nofree/distinct:5/j:abilities/nekkie/nodupes Twild/sparse:80/maxtier:7 Spro Bstandard/alt:gauntlet Etoggle Glife/sylph/backrow -kit:basic -spoon -wacky:omnidextrous' })}>OmniDexterous</button>
