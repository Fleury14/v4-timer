    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <div className="flag-presets">
                    <button onClick={() => this.setState({ flags: 'Orandom:5,gated_quest/win:crystal Kmain/summon/moon Pkey Cstandard/distinct:7/j:abilities/nodupes/bye Tpro Spro/sell:quarter Bstandard/alt:gauntlet Nchars/key Etoggle Glife/sylph -kit:basic -noadamants' })}>FG Mk.II</button>                    
