// Taken from http://ff4fe.com/script/flags.js
/* eslint-disable */
const _FE_FLAGSPEC = {
    "version": [
        4,
...
class FlagLogicCore {
    ...
    fix(flagset) {
        var ch, char_objective_flags, distinct_count, distinct_flags, has_unavailable_characters, log, only_flags, pass_quest_flags, pool, required_chars, win_flags;
        log = [];
